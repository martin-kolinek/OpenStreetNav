...
LineDisplayStyle::LineDisplayStyle(double red, double green, double blue, double alpha, double thickness, ArrowStyle arrow):
    red(red),
    green(green),
    blue(blue),
    alpha(alpha),
...
ArrowStyle LineDisplayStyle::draw_arrow() const
{
    return arrow;
}
