--type psql::BindTypes<int64_t, int64_t, int64_t, int, int>, psql::RetTypes<>
...
--test-param 41, 10, 11, 0, 1

INSERT INTO Edges (WayID, StartNodeID, EndNodeID, StartSequenceNo, EndSequenceNo, Location)
    SELECT $1, $2, $3, $4, $5, ST_MakeLine(n1.Location::geometry, n2.Location::geometry)::geography FROM Nodes n1, Nodes n2 WHERE n1.ID=$2 AND n2.ID=$3
